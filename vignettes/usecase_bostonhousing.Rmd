...
source(system.file("code_helpers/vignette_link_helpers.R", package = "mlr3keras"))
```
...
Tp scale the data we create a `"PipeOpScale"` that is going to be connected to the learner before training.
