...
They can be used like any other `Learner`.
...
## Setup keras using Conda

The example below shows how to setup **reticulate** using a conda virtual environment (condaenv) and installing all packages.
We create a new "condaenv" called **mlr3keras** with some packages already installed using Python Version `3.8`.
Afterwards, we install keras and tensorflow into this environment again using **conda**.
