...
lrn$param_set$values$optimizer = optimizer_adam(lr = 0.05)
lrn$param_set$values$layer_units = c(8, 8)
...
```{r}
lrn$lr_find(mlr_tasks$get("iris"), epochs = 20L, batch_size = 32L)
```
